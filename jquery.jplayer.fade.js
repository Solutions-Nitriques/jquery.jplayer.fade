...
(function ($, undefined) {
	...
	function assurePlayerSound(player) {
	...
	function setVolume(player, v) {
		player.jPlayer('volume', v);
		player.data('volume', v);
	};
	
	function fadeToPlayer(player, dur, from, to, callback, debug) {
	...
	// quick fade out
	function fadeOutPlayer(player, dur, _in, _out, callback, debug) {
		player = assurePlayerSound(player);
	...
	function fadeInPlayer(player, dur, _in, _out, callback, debug) {
		player = assurePlayerSound(player);
